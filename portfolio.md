...
[Ver prévia do projeto]({{ site.baseurl }}{% post_url 2026-08-03-app-delivery-urbano %})

### Marketplace local
Um catálogo fictício para conectar produtores locais com clientes interessados em produtos artesanais.

[Ver prévia do projeto]({{ site.baseurl }}{% post_url 2026-08-05-marketplace-local %})